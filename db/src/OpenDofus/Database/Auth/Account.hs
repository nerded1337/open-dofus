...
newtype AccountLastConnectionDate =
  AccountLastConnectionDate
...
newtype AccountLastConnectionIP =
  AccountLastConnectionIP
...
newtype AccountTicketCreationDate =
  AccountTicketCreationDate
...
newtype AccountSubscriptionExpirationDate =
...
instance Table AccountTicketT where
  data PrimaryKey AccountTicketT f = AccountTicketPK !(C f
                                                       AccountTicketId)
                                     deriving (Generic, Beamable)
